...
import { FaEdit, FaTrash, FaPlus, FaSearch, FaList, FaUtensils, FaInfoCircle, FaCheck } from "react-icons/fa";
...
function Alimentos() {
  ...
  // Filtrar datos según búsqueda - SOLO ALIMENTOS INACTIVOS
  const filteredData = alimentoList.filter(item =>
    ...
    item.activo === 0 // Solo alimentos inactivos
  );
  ...
  // Handlers para CRUD - Función modificada para handleUpdate
  const handleAdd = () => {
    createAlimentojs(alimentoData, setShowModal, () => getAlimentosjs(setAlimentoList));
  };

 const handleUpdate = () => {
  // Pasamos setShowEditModal como tercer parámetro
  updateAlimentojs(selectedAlimento.id, alimentoData, setShowEditModal, () => {
    getAlimentosjs(setAlimentoList);
  });
};
  ...
  // Handler para aprobar alimento (cambiar de inactivo a activo)
  const handleApprove = (alimento) => {
  const updatedData = {
    ...alimento,
    activo: 1 // Cambiar a activo
  };
  
  // Pasamos setShowEditModal como tercer parámetro
  updateAlimentojs(alimento.id, updatedData, setShowEditModal, () => getAlimentosjs(setAlimentoList));
};
                ...
                <div className="card crud-card">
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-end gap-2">
                      ...
                      <button
                        className="crud-btn btn-success btn-sm"
                        onClick={() => handleApprove(alimento)}
                        title="Aprobar alimento"
                      >
                        <FaCheck />
                      </button>
                      <button
                ...
                <div className="nutrition-label p-3">
                  ...
                  <div className="nutrition-facts">
                    ...
                    <div className="nutrition-footer mt-3">
                      <p className="small mb-1" style={{ color: "black" }}> 
